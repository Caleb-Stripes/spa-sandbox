...
const image3 = "./resources/Logo.jpg"
const img3Lab = "My Logo"
const img3BD = "./resources/Blank.JPG"
...
const info3 = "Something I whipped up just for fun."
...
function nextImage() {
    if (currentImage == image0) {
        ...
        currentImage = image3;
        document.getElementById('photo').src = image3;
        document.getElementById('photoLabel').innerHTML = img3Lab;
        document.getElementById('photoBackDrop').src = img3BD;
        document.getElementById('infoText').innerHTML = info3;
    }
